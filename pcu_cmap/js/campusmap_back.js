 ...
 * 0 : 본교(신관) , 1 : 본교(옥룡) , 2 : 천안 , 3 : 예산
 */
var CAMPUS_NAME = ['본교 공주캠퍼스(신관)', '본교 공주캠퍼스(옥룡)', '본교 천안캠퍼스', '본교 예산캠퍼스'];
var map_coordinate = [
     {x: 36.46895240928467, y: 127.14081145211509, zoom: 3, marker: null}
    ,{x: 36.45178639343022, y: 127.13271552090906, zoom: 2, marker: null}
    ,{x: 36.8509856368007,  y: 127.15068940817875, zoom: 2, marker: null} 
    ,{x: 36.6695944438778,  y: 126.85984171121828, zoom: 3, marker: null}  
];
var color_marker = [
    {'m1':'r', 'm2':'r', 'm3':'r', 'm4':'r', 'm5':'r', 'm6':'r', 'm7':'r', 'm8':'r', 'm9':'r', 'm10':'r' 
    ,'m11':'r', 'm12':'b', 'm13':'b', 'm14':'b', 'm15':'b', 'm16':'b', 'm17':'b', 'm18':'b', 'm19':'b', 'm20':'b'
    ,'m21':'b', 'm22':'b', 'm22-1':'b', 'm23':'b', 'm24':'b', 'm25':'b', 'm26':'b', 'm27':'g', 'm28':'g', 'm29':'g', 'm30':'g'
    ,'m31':'g', 'm32':'g', 'm33':'g', 'm34':'g', 'm35':'g', 'm36':'g', 'm37':'g', 'm38':'g', 'm39':'g', 'm40':'g'
    ,'m41':'g', 'm42':'g', 'm43':'g', 'm44':'g', 'm45':'g', 'm46':'g', 'm47':'g', 'm48':'g', 'm49':'g'}  
    ,{'m1':'r', 'm2':'r', 'm3':'r', 'm4':'r', 'm5':'r', 'm6':'r', 'm7':'r', 'm8':'r', 'm9':'r', 'm10':'r'}    
    ,{'m1':'g', 'm2':'g', 'm3':'g', 'm4':'g', 'm5':'g', 'm6':'g', 'm7':'g', 'm8':'g', 'm9':'g', 'm10':'g' 
    ,'mA':'r', 'mB':'r', 'mC':'r', 'mD':'r', 'mE':'r', 'mF':'r', 'mG':'r', 'mH':'r', 'mI':'r', 'mJ':'r'}
    ,{'m1':'r', 'm2':'r', 'm3':'r', 'm4':'r', 'm5':'r', 'm6':'r', 'm7':'r', 'm8':'r', 'm9':'r', 'm10':'r' 
    ,'m11':'r', 'm12':'r', 'm13':'r', 'm14':'r', 'm15':'r', 'm16':'r', 'm17':'r', 'm18':'r', 'm19':'r', 'm20':'r'}
];
var door_coordinate = [
    [ {x: 36.468326203288576, y: 127.14336124667902, title: '정문', cssname: 'f-door'}
     ,{x: 36.469780750372216, y: 127.1383374808106,  title: '후문', cssname: 'b-door'}
    ...
    ,[{x: 36.85047088153115, y: 127.15506830117047, title: '정문', cssname: 'f-door'}
     ,{x: 36.8494926123431,  y: 127.15202215624547, title: '후문', cssname: 'b-door'}]

    ,[{x: 36.67286740425771, y: 126.85760542086012, title: '정문', cssname: 'f-door'}]
];
...
function init() {
    ...
    for (var i in omap_marker) {
        omap_positions.push(jsonParse(i,omap_marker[i]));
    } 
    ...
    for (var i in ymap_marker) {
        ymap_positions.push(jsonParse(i,ymap_marker[i]));
    } 
    map_coordinate[0].marker = smap_positions;
    map_coordinate[1].marker = omap_positions;
    map_coordinate[2].marker = cmap_positions;   
    map_coordinate[3].marker = ymap_positions;

    switch(getParameterByName('map')) {
        case 'smap': nIdx = 0; sIdx = 1; $('.smap').addClass('on'); break;
        case 'omap': nIdx = 1; sIdx = 2; $('.smap').addClass('on'); break;
        case 'cmap': nIdx = 2; sIdx = 1; $('.cmap').addClass('on'); break;
        case 'ymap': nIdx = 3; sIdx = 1; $('.ymap').addClass('on'); break;
        default : nIdx = 0; sIdx = 1; $('.smap').addClass('on'); break;
    }
}

function initUI() {
    var btnDOM = "<div class='camp-btn'>";
        btnDOM += "<a href='#' class='camp-btn1' onclick='javascript:changeMap(1); return false'>신관</a>";
        btnDOM += "<a href='#' class='camp-btn2' onclick='javascript:changeMap(2); return false'>옥룡</a>";
        btnDOM += "</div>";
        $('#camp-list').append(btnDOM);
        $('.camp-btn' + sIdx).addClass('on');
    ...
    var viewsDOM = "";
        ...
        viewsDOM += "<div class='view-info'><div class='floor-vtitle'><span class='blt'></span>층별안내</div><div class='floor-vdetails' />";
        viewsDOM += "<div class='dept-vtitle'><span class='blt'></span>학과안내</div><div class='dept-vdetails' /></div>";
...
function setCampusList(n) {
    ...
    // 신관 | 옥룡 버튼생성
    if(n == 0 || n == 1) {
        $('.camp-btn').css({"display" : "block"});
        $('.camp-btn1').removeClass('on');
        $('.camp-btn2').removeClass('on');
        $('.camp-btn' + sIdx).addClass('on');
    } else {
        $('.camp-btn').css({"display" : "none"});
    }
