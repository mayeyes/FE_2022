...
//플러그인 import
var jsImport = [contextPath + '/js/core/plug/calendar/jquery-ui.js', contextPath + '/js/core/plug/jquery-mousewheel-3.1.11/jquery.mousewheel.min.js', contextPath + '/js/core/plug/jquery.scrollTo-1.4.13/jquery.scrollTo.min.js', contextPath + '/js/core/plug/custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js', contextPath + '/js/core/print/jquery.printElement.js', contextPath + '/js/core/plug/rwdImageMaps/jquery.rwdImageMaps.min.js'];

/*
if(document.location.protocol == 'http:'){
	document.write('<script type="text/javascript" src="http://dmaps.daum.net/map_js_init/roughmapLoader.js"></script>');
}else{ // https
	document.write('<script type="text/javascript" src="https://ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>');
}
*/
...
document.write('<script src="./js/site/kor/content.js"></script>');
document.write('<script src="' + contextPath + '/js/core/html5.js"></script>');
document.write('<script src="' + contextPath + '/js/core/respond.min.js"></script>');
