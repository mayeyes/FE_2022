...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// */
//blog
function blogOpen(idx){
	var titl = "";
	if($("#txt h3").length>0){
		titl = $("#txt h3").text();
	}else{
		titl = $("#visual .layout h2 strong").text().trim();
	}
	titl = titl.replace ('"', '&quot;');
	titl = titl.replace ('"', '&quot;');
...
function facebookOpen(idx){
	...
	shareDB('facebook',idx);

	snswindowOpen (url, 900, 450, 'no');
}
//twitter
function twitterOpen(idx){
	var titl = "";
	if($("#txt h3").length>0){
		titl = $("#txt h3").text();
	}else{
