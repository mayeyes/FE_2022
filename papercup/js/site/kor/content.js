...
function Tmenu_setting(str){
    ...
    $('#header .head_top .wraps').clone(false).insertBefore($("#slide_map .inner .binds >ul"));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// */
$(document).ready(function(){ 
    var fileTarget = $('.file_input input'); 
...
function popup_open_AC(str){
	...
	box.btn_no.click(function(){ box.fadeOut(); $(".file_name").text("파일찾기"); return false; });  //취소
	box.c.click(function(){ box.fadeOut(); $(".file_name").text("파일찾기"); return false; });  //닫기
