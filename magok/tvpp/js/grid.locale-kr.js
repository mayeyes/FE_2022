...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "李얘린",
		Reset: "珥덇린��",
		odata: [{ oper:'eq', text:"媛숇떎"},{ oper:'ne', text:"媛숈� �딅떎"},{ oper:'lt', text:"�묐떎"},{ oper:'le', text:"�묎굅�� 媛숇떎"},{ oper:'gt', text:"�щ떎"},{ oper:'ge', text:"�ш굅�� 媛숇떎"},{ oper:'bw', text:"濡� �쒖옉�쒕떎"},{ oper:'bn', text:"濡� �쒖옉�섏� �딅뒗��"},{ oper:'in', text:"�댁뿉 �덈떎"},{ oper:'ni', text:"�댁뿉 �덉� �딅떎"},{ oper:'ew', text:"濡� �앸궃��"},{ oper:'en', text:"濡� �앸굹吏� �딅뒗��"},{ oper:'cn', text:"�댁뿉 議댁옱�쒕떎"},{ oper:'nc', text:"�댁뿉 議댁옱�섏� �딅뒗��"},{ oper:'nu', text:'is null'},{ oper:'nn', text:'is not null'}],
